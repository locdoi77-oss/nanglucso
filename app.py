...
<div class="main-header">
    ...
    <p>Tác giả: Lộc Thị Đợi - Trường Tiểu học Quyết Tiến - ĐT: 037 8976 996</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lộc Thị Đợi - Trường Tiểu học Quyết Tiến - ĐT: 037 8976 996</div>", unsafe_allow_html=True)
